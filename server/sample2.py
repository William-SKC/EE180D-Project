...
def streamData(data_array):
    ...
    elif data_array[0] <= 8.5 and data_array[0] > 7.5 and data_array[1] <= 8.9 and data_array[1] > 7.9:                      position = "Position 33"
    ...
    result1 = firebase.post('loc_data1', {'time':data_array[0], 'dx':data_array[1], 'dy':data_array[2]})
    #print data_list[0]
    #print data_list[1]
    #print data_list[2]
